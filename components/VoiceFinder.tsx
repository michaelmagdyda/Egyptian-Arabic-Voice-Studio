...
const VoiceFinder: React.FC<VoiceFinderProps> = ({ voices, onRecommendation, onClose }) => {
  ...
  const examples = [
    { label: "صوت الولد (Achird / Charon)", text: "Natural Egyptian Arabic male voice, young adult (25–30), warm, calm and reflective voice-over. Achird or Charon." },
    { label: "صوت البنت (Aoede / Leda)", text: "Natural Egyptian Arabic female voice, warm, sincere, gentle and engaging voice-over. Aoede or Leda." },
    { label: "Egyptian Arabic narrator", text: "Natural Egyptian Arabic voice, warm and realistic, authentic Egyptian pronunciation. Male narrator: 25–30 years old, warm, confident and friendly." },
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const prompt = `
        ...
        2. Create a detailed System Instruction that defines the persona/character with flexible, general Director's notes.
        ...
        ## Scene
        Sets the stage. Describes both the physical environment and the overall mood.
        
        ## Director's Notes
        Versatile, general performance guidance (vocal warmth, dialect/accent authenticity, breathing, pacing, pauses, and emotional delivery) that applies dynamically to any script rather than locked to one single sentence.
